...
// const { getClasses } = require('./classApi');


// async function markOffCompletedClassesDeterminedByPrestigeRank(oldUserData, updatedUserData, classData, member, client, openai, memberRoles){
//     try{
...
//             //make an array of the prestiges
//             for (const classObj of classes) {
//                 if (!classesByLevel[classObj.prestige_category]) {
//                     classesByLevel[classObj.prestige_category] = {};
//                 }
//                 // classesByLevel[classObj.prestige_category].push(classObj);
//             }

//             //make further level arrays and then fill them with the classes that belong there
//             for (const classObj of classes) {
//                 if (!classesByLevel[classObj.prestige_category][classObj.level]) {
//                     classesByLevel[classObj.prestige_category][classObj.level] = [];
//                 }
//                 // console.log(classObj)
//                 classesByLevel[classObj.prestige_category][classObj.level].push(classObj);
//             }

//             //get the user prestige levels
            
//             // console.log(prestigeRoles)
...
//         }
//     }catch(error){
//         console.error('Error in markOffCompletedClassesDeterminedByPrestigeRank:', error);
//     }
// }

// async function checkForPrestigePromotionUpdateUserlist(oldUserData, updatedUserData, classData, member, client, openai) {
//     try {
//         const prestigeRoles = await getPrestiges(); // Fetch prestige roles dynamically
...
//     markOffCompletedClassesDeterminedByPrestigeRank,
